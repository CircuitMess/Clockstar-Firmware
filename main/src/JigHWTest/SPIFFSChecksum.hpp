...
struct {
	...
	uint32_t sum;
		...
		{ "/spiffs/bg.bin",                       475868 },
		{ "/spiffs/icon/app_inst.bin",            4907 },
		{ "/spiffs/icon/app_mess.bin",            2115 },
		{ "/spiffs/icon/app_sms.bin",             1375 },
		{ "/spiffs/icon/app_snap.bin",            1222 },
		{ "/spiffs/icon/app_tiktok.bin",          2532 },
		{ "/spiffs/icon/app_wapp.bin",            1998 },
		{ "/spiffs/icon/call_in.bin",             1109 },
		{ "/spiffs/icon/call_miss.bin",           1024 },
		{ "/spiffs/icon/call_out.bin",            1239 },
		{ "/spiffs/icon/cat_email.bin",           1368 },
		{ "/spiffs/icon/cat_entert.bin",          4057 },
		{ "/spiffs/icon/cat_fin.bin",             4248 },
		{ "/spiffs/icon/cat_health.bin",          2065 },
		{ "/spiffs/icon/cat_loc.bin",             4214 },
		{ "/spiffs/icon/cat_news.bin",            2858 },
		{ "/spiffs/icon/cat_other.bin",           1286 },
		{ "/spiffs/icon/cat_sched.bin",           2724 },
		{ "/spiffs/icon/cat_soc.bin",             1352 },
		{ "/spiffs/icon/etc.bin",                 1278 },
		{ "/spiffs/icon/lock_closed.bin",         3508 },
		{ "/spiffs/icon/lock_open.bin",           3554 },
		{ "/spiffs/icon/trash.bin",               2454 },
		{ "/spiffs/icon/trash_sel.bin",           2086 },
		{ "/spiffs/icon/x.bin",                   2870 },
		{ "/spiffs/icon/x_sel.bin",               2502 },
